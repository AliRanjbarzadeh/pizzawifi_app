...
package ir.atriatech.customlibs.pinview;
...
public class PinView extends AppCompatEditText {
    ...
    public PinView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        ...
        mFontPath = a.getString(R.styleable.PinView_fontPath);
        ...
        if (mFontPath != null && !isInEditMode()) {
            Typeface typeface = Typeface.createFromAsset(getContext().getAssets(), mFontPath);
            mTextPaint.setTypeface(typeface);
            mAnimatorTextPaint.setTypeface(typeface);
        }
