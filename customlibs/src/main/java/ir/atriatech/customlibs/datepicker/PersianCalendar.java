...
public class PersianCalendar extends GregorianCalendar {
	 ...
	 *
	 */
	public String getPersianLongDateWithOutDay() {
		return AnyNum.anyToFa( this.persianDay + " / " + getPersianMonthName() + " / " + this.persianYear);
	}

	public String getPersianLongDate() {
		return AnyNum.anyToFa(getPersianWeekDayName() + "  " + this.persianDay + " / " + getPersianMonthName() + " / " + this.persianYear);
	}

	public String getPersianLongDateAndTime() {
		return AnyNum.anyToFa(getPersianLongDate() + " ساعت " + get(HOUR_OF_DAY) + ":" + get(MINUTE) + ":" + get(SECOND));
	}
