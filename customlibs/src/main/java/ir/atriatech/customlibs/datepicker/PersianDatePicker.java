...
//        yearNumberPicker.setTypeface(R.string.app_font);
//        monthNumberPicker.setTypeface(R.string.app_font);
//        dayNumberPicker.setTypeface(R.string.app_font);
        ...
        if (displayDescription) {
            ...
            descriptionTextView.setText(getDisplayPersianDate().getPersianLongDateWithOutDay());
        }
    ...
    NumberPicker.OnValueChangeListener dateChangeListener = new NumberPicker.OnValueChangeListener() {
        ...
        public void onValueChange(NumberPicker picker, int oldVal, int newVal) {
            ...
            if (displayDescription) {
                ...
                descriptionTextView.setText(AnyNum.anyToFa(getDisplayPersianDate().getPersianLongDateWithOutDay()));
            }
