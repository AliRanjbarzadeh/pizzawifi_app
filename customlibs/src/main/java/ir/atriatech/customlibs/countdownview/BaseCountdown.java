package ir.atriatech.customlibs.countdownview;
...
//        if (!isShowMinute && !isShowSecond) isShowSecond = true;
    ...
    protected void initPaint() {
        ...
        if (fontPath != null && !fontPath.isEmpty()) {
            mTimeTextPaint.setTypeface(Typeface.createFromAsset(mContext.getAssets(), fontPath));
            mSuffixTextPaint.setTypeface(Typeface.createFromAsset(mContext.getAssets(), fontPath));
        }
    ...
    protected void initTimeTextBaseInfo() {
        ...
        Rect rect = new Rect();
        mTimeTextPaint.getTextBounds("88", 0, 2, rect);
