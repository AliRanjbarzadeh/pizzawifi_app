...
public class ProgressView extends View {
    ...
    private void updateShader() {
        ...
        Shader shader;
        if (mShape == Shape.ARC) {
            shader = new LinearGradient(0, width / 2, width, height, mGradientColorList, null, Shader.TileMode.CLAMP);
        } else  if (mShape == Shape.CIRCLE) {
            shader = new LinearGradient(0, 0, width, height, mGradientColorList, null, Shader.TileMode.CLAMP);
        } else {
            shader = new LinearGradient(0, 0, width, 0, mGradientColorList, null, Shader.TileMode.CLAMP);
        }
