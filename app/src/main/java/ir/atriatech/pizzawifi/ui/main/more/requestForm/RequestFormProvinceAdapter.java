...
public class RequestFormProvinceAdapter extends MenuBaseAdapter<ProvinceModel> {
    ...
    public View getView(int index, View view, ViewGroup viewGroup) {
        ...
        if (view == null) {
            ...
            view = inflater.inflate(R.layout.temp_request_province, viewGroup, false);
        }

        ProvinceModel item = (ProvinceModel) getItem(index);
