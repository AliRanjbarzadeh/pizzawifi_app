...
import ir.atriatech.pizzawifi.databinding.FragmentLawBinding
import ir.atriatech.pizzawifi.entities.GeneralModel

class LawFragment : BaseFragment() {
    lateinit var binding: FragmentLawBinding
    private lateinit var mViewModel: LawFragmentViewModel

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        mViewModel = ViewModelProvider(this).get(LawFragmentViewModel::class.java)
        mObserver()
    }
    ...
    override fun onCreateView(
        ...
        binding = DataBindingUtil.inflate(inflater, R.layout.fragment_law, container, false)
