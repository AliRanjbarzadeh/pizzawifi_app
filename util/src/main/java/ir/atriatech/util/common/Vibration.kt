...
package ir.atriatech.util.common

import android.content.Context
import android.os.*
import ir.atriatech.extensions.kotlin.d
import ir.atriatech.util.BuildConfig
import java.util.*
...
object Vibration {
	...
	fun init(applicationContext: Context) {
		...
		if (rumbleDisabled && BuildConfig.DEBUG) {
			...
			d(
				"System does not have a Vibrator, or the permission is disabled. \" + \"Rumble has been turned rest. Subsequent calls to static methods will have no effect.",
				"Rumble"
			)
		}
	}
